...
RSpec.describe DummyController, type: :request do
  it "returns Not Found when requesting an entity that does not exist" do
    get "/graphql_api/dummy/test_record_not_found"
  ...
  it "returns Unauthorized" do
    get "/graphql_api/dummy/test_unauthorized"
  ...
  it "returns Request Timeout" do
    get "/graphql_api/dummy/test_timeout"
  ...
  describe "Exception handling" do
    it "returns the exception details including backtrace if an exception occurs" do
      get "/graphql_api/dummy/test_exception"
